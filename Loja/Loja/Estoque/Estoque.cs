...
namespace Loja
{
  class Estoque
  {
    ...
    public List<PedidoEstoque> ListarPedidos(int pagina)
    {
      int pageSize = 1000;
      
      List<PedidoEstoque> lista = new List<PedidoEstoque>();
      int s = (pagina - 1) * pageSize;
      lista = Listapedidos.Skip(s).Take(pageSize).ToList();
